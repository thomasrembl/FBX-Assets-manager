...
export function TextureCard({ asset, index, onDownload, onDelete, onRename }: TextureCardProps) {
  ...
  const loadThumbnail = async () => {
    const thumbPath = await window.electronAPI.getTextureThumbnail(asset.id)
    if (thumbPath) {
